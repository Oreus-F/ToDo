...
const ProjectManager = function(){
    ...
    const createFirstTask = function(){
        ...
        createTask('Edit username', 'low', '01/09/2025', 'In the sidebar you will find a button next to your actual username');
        createTask('Edit profile picture', 'low', '02/09/2025', 'In the sidebar you will find a button next to your actual username');
        ...
        createTask('Edit a task', 'high', '06/09/2025', 'change the title, priority, description, date or all of it');
