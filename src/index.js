...
import { getCalendarDays, addOneMonth, subOneMonth, createCalendar, createCalendarArray, getOneMonthBefore, getOneMonthAfter } from './bookingCalendar';
...
const monthAfter = getOneMonthAfter(todayBookingCalendar);
